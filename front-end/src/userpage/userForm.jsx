...
const UserForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigate to UserHome.jsx after successful submission
      setTimeout(() => navigate("/userHome"), 1500); // ✅ Corrected route
    } catch (error) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-black to-blue-900 text-white">
      <form
        className="p-8 rounded-xl shadow-lg w-full max-w-md border border-blue-500"
